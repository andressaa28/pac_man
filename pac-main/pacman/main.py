...
class PacMan:
    def __init__(self, scale):
        ...
        # Pac-Man
        pac_man_1 = pg.image.load('pacman/img/prin1.png')
        pac_man_2 = pg.image.load('pacman/img/prin2.png')
        pac_man_3 = pg.image.load('pacman/img/prin3.png')
        pac_man_4 = pg.image.load('pacman/img/prin4.png')
        pac_man_5 = pg.image.load('pacman/img/prin5.png')
        pac_man_6 = pg.image.load('pacman/img/prin6.png')
        pac_man_7 = pg.image.load('pacman/img/prin7.png')
        pac_man_8 = pg.image.load('pacman/img/prin8.png')
        pac_man_9 = pg.image.load('pacman/img/prin9.png')
        pac_man_10 = pg.image.load('pacman/img/prin10.png')
        pac_man_11 = pg.image.load('pacman/img/prin11.png')
