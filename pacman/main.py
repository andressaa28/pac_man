...
def escolher_personagem():
    ...
    personagens = [
        ...
        pg.image.load('img/personagem1/prin1-1.png'),
        pg.image.load('img/personagem2/prin1-2.png'),
        pg.image.load('img/personagem3/prin1-3.png'),
    ]
    personagens = [pg.transform.scale(p, (scale * 3, scale * 3)) for p in personagens]
    ...
    while escolhendo:
        clock.tick(30)
        window.fill((15, 71, 117)) # fundo azul escuro 
        ...
        espacamento = scale * 5 
        total_largura = len(personagens) * (scale * 2) + (len(personagens) - 1) * espacamento
        inicio_x = (window_width - total_largura) // 2
        y_personagem = scale * 7

        for i, img in enumerate(personagens):
            x = inicio_x + i * (scale * 2 + espacamento)
            if i == selecao:
                pg.draw.rect(window, (255, 255, 255), (x - 5, y_personagem - 5, img.get_width() + 10, img.get_height() + 10), 2)
            window.blit(img, (x, y_personagem))

        # instruções no rodapé 
        instrucoes = small_font.render("Use ← → para escolher, ENTER para confirmar", True, (255, 255, 255))
    ...
    return selecao
        ...
        #for i, img in enumerate(personagens):
         ...
         #  y = scale * 5
          #if i == selecao:
          #    pg.draw.rect(window, (255, 255, 255), (x - 5, y - 5, img.get_width() + 10, img.get_height() + 10), 2)
          # window.blit(img, (x, y))
...
class PacMan:
    def __init__(self, scale, selected_character=0):
        ...
        char_folder = [
            "img/prin1.png",
            "img/personagem1",
            'pacman/img/personagem2',
            'pacman/img/personagem3',
        ][self.selected_character]

        self.white = (255, 255, 255)
        self.black = (15, 71, 117)
        self.blue  = ( 25,  25, 255)
        scale = 18
       ...
       # self.pac_man_3 = pg.transform.scale(pac_man_3, (self.scale * 1.3, self.scale * 1.3))
        ...
        # Blue Ghost
        ghost_blue_down_right_0 = pg.image.load('pacman/img/fan_marshmallow1.png')
        ghost_blue_down_right_1 = pg.image.load('pacman/img/fan_marshmallow2.png')
        ...
        # Orange Ghost
        ghost_orange_down_right_0 = pg.image.load('pacman/img/fan_roxo1.png')
        ghost_orange_down_right_1 = pg.image.load('pacman/img/fan_roxo2.png')
        ...
        # Pink Ghost
        ghost_pink_down_right_0 = pg.image.load('pacman/img/fan_verde1.png')
        ghost_pink_down_right_1 = pg.image.load('pacman/img/fan_verde2.png')
        ...
        # Red Ghost
        ghost_red_down_right_0 = pg.image.load('pacman/img/dog1.png')
        ghost_red_down_right_1 = pg.image.load('pacman/img/dog2.png')
        ...
        # Harmless Ghost
        ghost_harmless_0       = pg.image.load('pacman/img/fan_marshmallow7.png')
        ghost_harmless_1       = pg.image.load('pacman/img/fan_roxo8.png')
